...
public class Competition {
    ...
    public static void main(String[] args) throws IOException {
        String filePath = "src/main/resources/result1.csv";
    ...
    public void competitonResult(List<Competitor> competitorsResult) {
        ...
        System.out.println("Winner - " + first.getAthleteName() + " " + first.getTotalMin() + ":" + first.getTotalSec() + " (" + first.getSkiTimeResult() + " + " + first.getPenality() + ")");
        System.out.println("Runner-up - " + second.getAthleteName() + " " + second.getTotalMin() + ":" + second.getTotalSec() + " (" + second.getSkiTimeResult() + " + " + second.getPenality() + ")");
        System.out.println("Third Place - " + third.getAthleteName() + " " + third.getTotalMin() + ":" + third.getTotalSec() + " (" + third.getSkiTimeResult() + " + " + third.getPenality() + ")");
        System.out.println("Loser - " + fourth.getAthleteName() + " " + fourth.getTotalMin() + ":" + fourth.getTotalSec() + " (" + fourth.getSkiTimeResult() + " + " + fourth.getPenality() + ")");
    }
